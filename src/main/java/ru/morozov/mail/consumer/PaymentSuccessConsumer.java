...
public class PaymentSuccessConsumer implements MessageListener {
    ...
    @Override
    @JmsListener(destination = "${active-mq.payment-success-topic}")
    public void onMessage(Message message) {
        ...
        if (objectMessage != null) {
            try {
                PaymentSuccessMsg orderMsg = (PaymentSuccessMsg) objectMessage.getObject();
                ...
                mail.setBody(
                        ...
                        "Ваш заказ №" + order.getId() + " успешно оплачен."
                        );
